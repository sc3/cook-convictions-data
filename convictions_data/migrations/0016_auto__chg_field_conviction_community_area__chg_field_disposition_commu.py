...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conviction.community_area'
        db.alter_column('convictions_data_conviction', 'community_area_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['convictions_data.CommunityArea'], null=True))

        # Changing field 'Disposition.community_area'
        db.alter_column('convictions_data_disposition', 'community_area_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['convictions_data.CommunityArea'], null=True))

        # Changing field 'Disposition.conviction'
        db.alter_column('convictions_data_disposition', 'conviction_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['convictions_data.Conviction'], null=True))

        # Changing field 'CensusTract.community_area'
        db.alter_column('convictions_data_censustract', 'community_area_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['convictions_data.CommunityArea'], null=True))

    def backwards(self, orm):

        # Changing field 'Conviction.community_area'
        db.alter_column('convictions_data_conviction', 'community_area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['convictions_data.CommunityArea'], null=True))

        # Changing field 'Disposition.community_area'
        db.alter_column('convictions_data_disposition', 'community_area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['convictions_data.CommunityArea'], null=True))

        # Changing field 'Disposition.conviction'
        db.alter_column('convictions_data_disposition', 'conviction_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['convictions_data.Conviction'], null=True))

        # Changing field 'CensusTract.community_area'
        db.alter_column('convictions_data_censustract', 'community_area_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['convictions_data.CommunityArea'], null=True))
