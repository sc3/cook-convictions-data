...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conviction.iucr_category'
        db.add_column('convictions_data_conviction', 'iucr_category',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Conviction.ammnd_iucr_category'
        db.add_column('convictions_data_conviction', 'ammnd_iucr_category',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conviction.iucr_category'
        db.delete_column('convictions_data_conviction', 'iucr_category')

        # Deleting field 'Conviction.ammnd_iucr_category'
        db.delete_column('convictions_data_conviction', 'ammnd_iucr_category')
    ...
    models = {
        ...
        'convictions_data.conviction': {
            ...
            'ammnd_iucr_category': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
