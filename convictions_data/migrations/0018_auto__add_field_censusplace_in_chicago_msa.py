...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CensusPlace.in_chicago_msa'
        db.add_column('convictions_data_censusplace', 'in_chicago_msa',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CensusPlace.in_chicago_msa'
        db.delete_column('convictions_data_censusplace', 'in_chicago_msa')
