...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'County'
        db.create_table('convictions_data_county', (
            ...
            ('countyns10', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('geoid10', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ...
            ('csafp10', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('cbsafp10', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('metdivfp10', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ...
        db.send_create_signal('convictions_data', ['County'])


    def backwards(self, orm):
        # Deleting model 'County'
        db.delete_table('convictions_data_county')
    ...
    models = {
        ...
        'convictions_data.conviction': {
            ...
            'final_chrgclass': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'db_index': 'True'}),
            'final_chrgdesc': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'db_index': 'True'}),
            'final_chrgtype': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1', 'db_index': 'True'}),
