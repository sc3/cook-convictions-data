...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conviction.place'
        db.add_column('convictions_data_conviction', 'place',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['convictions_data.CensusPlace'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conviction.place'
        db.delete_column('convictions_data_conviction', 'place_id')
    ...
    models = {
        ...
        'convictions_data.censustract': {
            ...
            'boundary': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {}),
            'community_area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['convictions_data.CommunityArea']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'convictions_data.conviction': {
            ...
            'place': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['convictions_data.CensusPlace']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'convictions_data.disposition': {
            ...
            'city': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'community_area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['convictions_data.CommunityArea']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'conviction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['convictions_data.Conviction']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'county': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'ctlbkngno': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'dob': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'fbiidno': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
