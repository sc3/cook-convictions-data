...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conviction.county'
        db.add_column('convictions_data_conviction', 'county',
                      self.gf('django.db.models.fields.CharField')(max_length=80, default=''),
                      keep_default=False)

        # Adding field 'Conviction.community_area'
        db.add_column('convictions_data_conviction', 'community_area',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['convictions_data.CommunityArea']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conviction.county'
        db.delete_column('convictions_data_conviction', 'county')

        # Deleting field 'Conviction.community_area'
        db.delete_column('convictions_data_conviction', 'community_area_id')
