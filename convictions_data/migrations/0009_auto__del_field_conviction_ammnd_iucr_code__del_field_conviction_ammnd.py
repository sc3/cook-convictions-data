...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Conviction.final_statute'
        db.add_column('convictions_data_conviction', 'final_statute',
    ...
    def backwards(self, orm):
        ...
        db.add_column('convictions_data_conviction', 'ammnd_iucr_code',
                      self.gf('django.db.models.fields.CharField')(max_length=4, default=''),
                      keep_default=False)
        ...
        # Deleting field 'Conviction.final_statute'
        db.delete_column('convictions_data_conviction', 'final_statute')
