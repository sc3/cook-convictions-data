...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CommunityArea.boundary'
        db.alter_column('convictions_data_communityarea', 'boundary', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')())

    def backwards(self, orm):

        # Changing field 'CommunityArea.boundary'
        db.alter_column('convictions_data_communityarea', 'boundary', self.gf('django.contrib.gis.db.models.fields.PolygonField')())
